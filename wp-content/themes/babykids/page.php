        ...
        <div class="nicdark_filter <?php echo $redux_demo['metabox_pages_header_filter']; ?>">
            ...
            <div class="nicdark_container nicdark_clearfix">
                ...
                <div class="grid grid_12">
                    ...
                    <h1 class="white subtitle"><?php echo $redux_demo['metabox_pages_header_title']; ?></h1>
                    <div class="nicdark_space10"></div>
                    <h3 class="subtitle white"><?php echo $redux_demo['metabox_pages_header_description']; ?></h3>
                    <div class="nicdark_space20"></div>
                    <?php if ( $redux_demo['metabox_pages_header_divider'] == 1 ){ ?> <div class="nicdark_divider left big"><span class="nicdark_bg_white nicdark_radius"></span></div> <?php } ?>
