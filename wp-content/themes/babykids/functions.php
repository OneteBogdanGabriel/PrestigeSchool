...
//translation
load_theme_textdomain( 'babykids', get_template_directory().'/languages' );
...
function nicdark_register_required_plugins() {
    ...
    $plugins = array(
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/revslider_22.zip', // The plugin source.
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com//themes/baby-kids/wp/plugins/contact-form-7_22.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/wordpress-importer_22.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/js_composer_22.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/nicdark-shortcodes_22.zip', // The plugin source.
            'required'           => true, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
        ...
        // Time Table
        array(
            'name'               => 'Time Table', // The plugin name.
            'slug'               => 'timetable', // The plugin slug (typically the folder name).
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/timetable_22.zip', // The plugin source.
        ...
        array(
            ...
            'source'             => 'http://www.nicdarkthemes.com/themes/baby-kids/wp/plugins/woocommerce_22.zip', // The plugin source.
            'required'           => false, // If false, the plugin is only 'recommended' instead of required.
            'external_url'       => '', // If set, overrides default API URL and points to an external URL.
        ),
...
function nicdark_register_my_menus() {
  register_nav_menu( 'main-menu', __( 'Main Menu', 'babykids' ) );  
}
...
function nicdark_posts_link_attributes_next() {
    return 'class="nicdark_btn nicdark_bg_green medium nicdark_shadow nicdark_radius white nicdark_press" title="Next"';
}
function nicdark_posts_link_attributes_previous() {
    return 'class="nicdark_disable_floatright_iphoneland nicdark_disable_floatright_iphonepotr nicdark_btn nicdark_bg_green medium right nicdark_shadow nicdark_radius white nicdark_press" title="Previous"';
}
