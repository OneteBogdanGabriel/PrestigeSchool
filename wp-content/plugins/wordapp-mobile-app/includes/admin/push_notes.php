...
<table class="widefat" width="30%" style="  width: 36%;">
	...
	<tr>
		<th class="row-title" style="color:green"><center><?php echo __( 'Upgrade Today only $2.99/mo','WordApp' ); ?></center></th>
							...
							<center><h2>- OR -</h2>
							Follow me on SnapChat and get free Push notification credits every week.<br />
							<a href="https://snapchat.com/add/appdevelopers">
								<img src="https://feelinsonice-hrd.appspot.com/web/deeplink/snapcode?username=appdevelopers&type=PNG"
								width="100px">
								<br>@appdevelopers</a>
<br />
