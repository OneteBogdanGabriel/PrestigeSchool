...
?>
			<div style="<?php echo $hiddenDivLiveNot;
	?>">
			 	<h3><?php _e('Live editor', 'wordapp-mobile-app');
	?>  	 <span style="float:right" class="spanHelp"><img src="<?php echo plugins_url(APPNAME.'/images/help.png')?>" style="vertical-align: middle;" width="24px"  height="24px"> <?php _e('Watch the video before using customizer', 'wordapp-mobile-app');
	?></span>	</h3>
		<hr>
		<center>	<a href="<?php echo get_admin_url().'customize.php?theme='.$varColor['mythemeName'].'&WordApp_demo=1&return='.urlencode(get_admin_url().'admin.php?page=WordAppBuilder').'';
	?>"><img src="<?php echo plugins_url(APPNAME.'/images/customizr.png');
	?>" width="90%"></a></center>
				<?php
...
?>
		...
		<div style="<?php echo $hiddenDivLive;
	?>">
...
?>
		...
		?></label>
			<select name="WordApp_menu[barstyle]">
				<option value="Default" <?php echo ($varMenu['barstyle'] == 'Default' || $varMenu['barstyle'] == '') ? 'selected' : '';  ?>><?php echo __('Default', 'wordapp-mobile-app');?></option>
...
?>
	...
	?>   <span style="float:right" class="spanHelp"><img src="<?php echo plugins_url(APPNAME.'/images/help.png')?>" style="vertical-align: middle;" width="24px"  height="24px"><?php _e('Activate & choice of icons', 'wordapp-mobile-app');
	?></span>	</h3>
	<hr>
         <p>
...
?>
	...
	?> <img src="<?php echo plugins_url(APPNAME.'/images/help.png')?>" style="vertical-align: middle;" width="18px"  height="18px"><?php _e('Activate & choice of icons', 'wordapp-mobile-app');
	?><a href="nav-menus.php"><?php _e('menu', 'wordapp-mobile-app');
	?></a> <?php _e('to attach to this navigation bar', 'wordapp-mobile-app');
	?> <br> <?php _e('Save to update icons', 'wordapp-mobile-app');
	?></span>
		<br / >
...
?>
        <img src="<?php echo esc_url($img_url);
	?>" style="max-width:200px;border: 2px dashed #e5e5e5;padding: 5px;" alt="" id="icon_url" title="" width="" height="" class="alignzone size-full wp-image-125" /></a>
        </p>
...
<hr>
  ...
  height: 620px">
					<div class="ios-device__screen" ><div id="signalBar"><img src="<?php echo plugins_url(APPNAME.'/images/ios-status-bar.png'); ?>" style="height:20px;width:100%"></div>
						<iframe width="100%" height="100%" src="<?php bloginfo('wpurl'); ?>/?WordApp_demo=1&WordApp_launch=1" id="fullpreviews"  ></iframe></div>
</div>
