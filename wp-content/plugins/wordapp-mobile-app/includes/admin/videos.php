...
<div class="plugin-card plugin-card-akismet">
			<div class="plugin-card-top wordapp-plugin-card-top">
				...
				<div class="action-links">
					<ul class="plugin-action-buttons"><li><a href="https://player.vimeo.com/video/<?php echo $posta['id']; ?>?TB_iframe=true&amp;width=772&amp;height=259" class="thickbox install-now button" href="" aria-label="Watch Now" data-name="Watch Now"><?php _e('Watch Now','wordapp-mobile-app'); ?></a></li><li></li></ul>				</div>
				<div class="desc column-description">
					<p><?php echo $posta['description']; ?></p>
					<p class="authors"> <cite><?php _e('By','wordapp-mobile-app'); ?> <a href="<?php echo $posta['user_url']; ?>"><?php echo $posta['user_name']; ?></a></cite></p>
				</div>
			</div>
			<div class="plugin-card-bottom wordapp-plugin-card-bottom">

				<div class="column-updated">
					<strong><?php echo __('Duration','wordapp-mobile-app'); ?></strong> <span title="6 Jul 2015 @ 23:44">
						<?php echo round($posta['duration']/60,2); ?> <?php _e('mins','wordapp-mobile-app'); ?>				</span>
				</div>

				<div class="wordapp-column-compatibility">
					<span class=""><strong><?php echo __('Tags','wordapp-mobile-app'); ?> :</strong> <?php echo $posta['tags']; ?></span>				</div>
			</div>
		</div>
