...
<ul>
	...
	<li><b><?php _e('How can my app make money?','wordapp-mobile-app'); ?></b> <br><?php _e('Once your app is submitted and approved, AdMob will place ads inside your app. After you’ve associated an AdMob account with your WordApp installation, you will earn revenue that is generated from the ads.','wordapp-mobile-app'); ?></li>
	<li><b><?php _e('How much money can I make?','wordapp-mobile-app'); ?></b> <br><?php _e('Earnings will depend on a number of factors. The two key factors are the type of ads and the pricing of ads appearing with your app.','wordapp-mobile-app'); ?></li>
	<li><b><?php _e('What is the Ad Share?','wordapp-mobile-app'); ?></b> <br><?php _e('If you are using the free version of WordApp the earnings are shared with WordApp by rotating the ads. If you are a premium user you will get 100% of the earnings or even turn the ads off','wordapp-mobile-app'); ?></li>
