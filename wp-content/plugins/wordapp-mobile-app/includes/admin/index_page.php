...
<div style="width:100%;height:100%;height: 400px; float: none; clear: both; margin: 2px auto;">
  <embed src="<?php echo $activate['homeVideo']; ?>?version=3&amp;hl=en_US&amp;rel=0&amp;autohide=1&amp;autoplay=0" wmode="transparent" type="application/x-shockwave-flash" width="100%" height="400px" allowfullscreen="true" title="Adobe Flash Player">
	...
	echo "<h2>".__('Invite your friends and get your android app for FREE!','wordapp-mobile-app')."</h2>";
endif;
?>
	...
	'Quick Links'
						...
						<div class="inside">
							...
							<ul>
								...
								<li><a href="https://wordpress.org/support/plugin/wordapp-mobile-app"><?php echo __('Mobile Marketing Community','wordapp-mobile-app'); ?> </a></li>
								<li><a href="http://app-developers.biz/blog/about/"><?php echo APPNAME_FRIENDLY ?> <?php echo __('About App Developers','wordapp-mobile-app'); ?> </a></li>
								<li><a href="https://wordpress.org/plugins/wordapp-mobile-app/changelog/"><?php echo APPNAME_FRIENDLY ?> <?php echo __('Changelog','wordapp-mobile-app'); ?> </a></li>
