	...
	?>
	<hr>
	<center><a href="https://wordpress.org/plugins/wordapp-mobile-app/" target="_blank" class="appdev">WordApp </a><a href="http://app-developers.biz/" target="_blank" class="appdev">convert wordpress to mobile app & site</a>
	</center>
	<?php
	}
	?>
...
jQuery(document).ready(function(){
	...
	$('a').on('click.myDisable', function(e) {e.preventDefault();
											  alert('Click disabled! This is just a demo. To see the full app in action please click on the red button above.');
											  return false; });
...
var iOSInterstitial = "<?php echo $varAdMob['iOSInterstitial']; ?>";
		...
		<script src="https://ajax.googleapis.com/ajax/libs/angularjs/1.4.5/angular.min.js"></script>
		       ...
		       <script type="text/javascript" src="https://s3.amazonaws.com/cordovajs/ng-cordova/ng-cordova.js?<?php echo date('Ymdhsi')?>"></script>
