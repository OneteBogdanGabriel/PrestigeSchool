...
<link rel='stylesheet'   href='<?php echo  WORDAPP_DIR_URL; ?>themes/MyTheme/slidebars/wavey.css' type='text/css' media='all' />
...
?>
		<div class="fixed-nav-bar" style="    min-height: 63px;">
			<div class="leftbtn"><a href="d" class="sb-toggle-left" style="    color: <?php echo $varColor['ColorText']; ?>;"><i class="fa fa-bars" aria-hidden="true"></i></a></div>
