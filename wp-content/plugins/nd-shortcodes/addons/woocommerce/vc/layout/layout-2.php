...
$str .= '
	...
	<div class="'.$nd_options_width.' nd_options_padding_15 nd_options_text_align_center nd_options_box_sizing_border_box nd_options_masonry_item nd_options_width_100_percentage_responsive nd_options_position_relative">
        
        '.$nd_options_sale_label.'

        '.$nd_options_output_image.'
        <div class="nd_options_section nd_options_height_20"></div>
        <h2><a class="nd_options_color_greydark nd_options_first_font" href="'.$nd_options_permalink.'">'.$nd_options_title.'</a></h2>
        <div class="nd_options_section nd_options_height_20"></div>
