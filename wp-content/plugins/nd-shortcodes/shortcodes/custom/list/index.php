...
{  
  ...
  if ( $nd_options_image_src != '' ) {
    $nd_options_output_image = '<img alt="" class="nd_options_position_absolute nd_options_position_initial_all_iphone nd_options_width_100_percentage_all_iphone nd_options_z_index_9" width="80" src="'.$nd_options_image_src[0].'">';
