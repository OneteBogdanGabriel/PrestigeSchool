...
<script>(function(d, s, id) {
  ...
  js.src = "//connect.facebook.net/en_US/sdk.js#xfbml=1&version=v2.5&appId=1493930974235667";
		...
		<div id="post-body" class="metabox-holder columns-2">
			...
			<div id="post-body-content">
					...
					<div class="postbox">
						...
						<div class="inside rc_mmip_general">
								...
								<table class="form-table">
									...
									<tr>
										<td colspan="2">
											<label>Delete saved settings on deactivation?</label> &nbsp;&nbsp;&nbsp;
											<select name="rc_maint_mode_deleteondeact">
												<option value="1"<? selected( $rc_mmip_deleteondeact, 1); ?>>YES</option>
												<option value="0"<? selected( $rc_mmip_deleteondeact, 0); ?>>NO</option>
											</select>
										</td>
									</tr>
									</tr>
						...
						<div class="inside rc_mmip_social">
							...
							<table class="form-table rc-mmip-table">
								...
								<tr>
									<td colspan="2">
										https://facebook.com/ <input type="text" name="rc_mmip_fb" id="rc_mmip_fb" class="regular-text" value="<?php if(is_array($rc_mmip_social) && !empty($rc_mmip_social)){ echo esc_html($rc_mmip_social['fb']['username']); } ?>">
										<input type="hidden" name="rc_mmip_fb_icon" value="fa-facebook">
										<p style="font-size:11px;">
											<em>To show Facebook icon, please insert the name of your Facebook page.</em>
										</p>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td colspan="2">
										https://twitter.com/ <input type="text" name="rc_mmip_tw" id="rc_mmip_tw" class="regular-text" value="<?php if(is_array($rc_mmip_social) && !empty($rc_mmip_social)){ echo esc_html($rc_mmip_social['tw']['username']); } ?>">
										<input type="hidden" name="rc_mmip_tw_icon" value="fa-twitter">
										<p style="font-size:11px;">
											<em>To show Twitter icon, please insert the name of your Twitter page.</em>
										</p>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td colspan="2">
										https://plus.google.com/+ <input type="text" name="rc_mmip_gp" id="rc_mmip_gp" class="regular-text" value="<?php if(is_array($rc_mmip_social) && !empty($rc_mmip_social)){ echo esc_html($rc_mmip_social['gp']['username']); } ?>">
										<input type="hidden" name="rc_mmip_gp_icon" value="fa-google-plus">
										<p style="font-size:11px;">
											<em>To show Google+ icon, please insert the name of your Google+ page.</em>
										</p>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td colspan="2">
										https://instagram.com/ <input type="text" name="rc_mmip_ig" id="rc_mmip_ig" class="regular-text" value="<?php if(is_array($rc_mmip_social) && !empty($rc_mmip_social)){ echo esc_html($rc_mmip_social['ig']['username']);  } ?>">
										<input type="hidden" name="rc_mmip_ig_icon" value="fa-instagram">
										<p style="font-size:11px;">
											<em>To show Instagram icon, please insert the name of your Instagram page.</em>
										</p>
									</td>
								</tr>
							</table>		
						...
						<div class="inside rc_mmip_mchimp mchimp_table">
								...
								<tr>
									<td colspan="2">
										Display a Subscribe Form - Connected to MailChimp. 
									</td>
								</tr>
								<tr>
									<td><label>Include Mailchimp Subscribe Form?</label></td>
									<td><select name="rc_mmip_mchimp_opt" id="rc_mmip_mchimp_opt">
												<option value="1" <? selected( $rc_mmip_mchimp_opt, 1); ?>>YES</option>
												<option value="0" <? selected( $rc_mmip_mchimp_opt, 0); ?>>NO</option>
											</select>
									</td>
								</tr>
								<tr class="section_title" <?php if($rc_mmip_mchimp_opt == 1):  ?> style="display:table-row;" <? endif; ?> >
									<td><label>Section Title:</label></td>
									<td><input type="text" class="regular-text" name="rc_mmip_mchimp_section_title" value="<?php echo esc_html($rc_mmip_mchimp_section_title); ?>"></td>
								</tr>
								<tr class="rc_mmip_mchimp_field" <? if($rc_mmip_mchimp_api != ''): ?> style="display:table-row;" <? endif; ?>>
									<td><label>API Key: </label></td>
									<td>
											<input type="text" name="rc_mmip_mchimp_api" id="rc_mmip_mchimp_api" class="regular-text" value="<?php echo esc_html($rc_mmip_mchimp_api);  ?>"> 
								...
								<tr class="rc_mmip_mchimp_lists" <? if($rc_mmip_mchimp_list != ''): ?> style="display:table-row;" <? endif; ?>>
                                ...
                                <tr class="successful_msg" <? if($rc_mmip_mchimp_opt == 1) : ?> style="display:table-row;" <? endif; ?>>
										<td><label>Successful Message:</label></td>
										<td><input type="text" class="regular-text" name="rc_mmip_mchimp_after_msg" value="<?php echo esc_html($rc_mmip_mchimp_after_msg); ?>">
                                        <p class="rc_maint_small_txt">
												This message will be displayed after the user has successfully entered his/her email address. Default: Thank you for subscribing to our mailing list.
											</p>
                                        </td>
								</tr>
								
								<tr class="google_captcha_opt" <?php if($rc_mmip_mchimp_opt == 1):  ?> style="display:table-row;" <? endif; ?> >
									<td><label>Add Google reCaptcha?</label></td>
									<td><select name="rc_mmip_mchimp_gcaptcha" id="rc_mmip_mchimp_gcaptcha">
												<option value="0" <? selected( $rc_mmip_mchimp_gcaptcha, 0); ?>>NO</option>
												<option value="1" <? selected( $rc_mmip_mchimp_gcaptcha, 1); ?>>YES</option>
											</select>
											<p class="rc_maint_small_txt">
												Insert your site/secret keys below. If you do not have them, go to <a href = "https://www.google.com/recaptcha/admin">
                				https://www.google.com/recaptcha/admin</a> to generate them.
											</p>
									</td>
								</tr>
								
								<tr class="google_captcha_keys" <? if($rc_mmip_mchimp_gcaptcha_site != '' && $rc_mmip_mchimp_opt == 1): ?> style="display:table-row;" <? endif; ?>>
									<td><label>Google reCaptcha Site Key: </label></td>
									<td><input type="text" name="rc_mmip_mchimp_gcaptcha_site" id="rc_mmip_mchimp_gcaptcha_site" class="regular-text" value="<?php echo esc_html($rc_mmip_mchimp_gcaptcha_site);  ?>"></td>
								</tr>
								<tr class="google_captcha_keys" <? if($rc_mmip_mchimp_gcaptcha_secret != '' && $rc_mmip_mchimp_opt == 1): ?> style="display:table-row;" <? endif; ?>>
									<td><label>Google reCaptcha Secret Key: </label></td>
									<td><input type="text" name="rc_mmip_mchimp_gcaptcha_secret" id="rc_mmip_mchimp_gcaptcha_secret" class="regular-text" value="<?php echo esc_html($rc_mmip_mchimp_gcaptcha_secret);  ?>"></td>
								</tr>
                ...
                <div class="meta-box-sortables ui-sortable" style="text-align: center;">
					<a href="http://www.1and1.com/?kwk=192245522" target="_blank"><img src="http://imagesrv.adition.com/banners/268/xml/1und1am/US_WM/WH/us_wh_an_728x90.gif" width="728" height="90"  border="0"/></a>
				</div>
			...
			<div id="postbox-container-1" class="postbox-container ">
				...
				<div class="meta-box-sortables">
					...
					<div class="postbox">
						...
						<div class="inside sidebar_rc_maint">
							<p class="rc_maint_info">
								Name: Maintenance Mode by IP Address <br />
								Author: Roberto Cabrera <br />
								Website: <a href="http://rcit.consulting" target="_blank">http://rcit.consulting</a>
								<br />
								<div class="fb-like" data-href="//www.facebook.com/wprcmaintenancebyip/" data-layout="button_count" data-action="like" data-show-faces="false" data-share="false"></div>
							</p>
						</div>
						<!-- .inside -->
                    ...
                    <div class="postbox">
						...
						<h3 class="hndle"><span><?php esc_attr_e(
									'Save Money on...', 'wp_admin_style'
								); ?></span></h3>

						<div class="inside sidebar_rc_maint">
							<a href="http://referrals.trhou.se/robertocabrera2" target="_blank"><img src="https://static.teamtreehouse.com/assets/content/referral-badge-grn.png" width="250" /></a>
					...
					<div class="postbox">
						...
						<div class="inside sidebar_rc_maint">
							<p class="rc_maint_info">
								...
								<b><em>Thank your for choosing 'Maintenance Mode By IP Address' plugin.</em></b>
							</p>
						</div>
						<!-- .inside -->
