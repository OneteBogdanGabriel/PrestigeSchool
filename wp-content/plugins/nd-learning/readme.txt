...
Tags: learning, courses, education, management system, training, teachers, e-learning, course, teacher, school, university
...
Perfect solution to manage courses and teachers. For any learning activities. Sell your courses with paypal integration and get contacts with free courses. Teaching and Learning WP plugin.

== Description ==

= Welcome to Learning Courses WP plugin =
This plugin is an useful LMS and you can see a video presentation below. 

[youtube https://www.youtube.com/watch?v=Fm_Cnfwsm0c]

= Below some live preview demos =
Click on the links below for view all plugin features in action:

* Single Course [view](http://www.nicdarkthemes.com/themes/education/wp/demo/university/courses/contemporary-art/)
* Archive Courses [view](http://www.nicdarkthemes.com/themes/education/wp/demo/university/courses/?nd_learning_arrive_from_advsearch=true&post_tag=&difficulty-level-course=&category-course=&location-course=&typology-course=&duration-course=)
* Single Teacher [view](http://www.nicdarkthemes.com/themes/education/wp/demo/university/teachers/jane-taylor/)
* Archive Teachers [view](http://www.nicdarkthemes.com/themes/education/wp/demo/university/teachers-archive/)
* Account Page [view](http://www.nicdarkthemes.com/themes/education/wp/demo/university/learning-account/)
...
4. Go in the plugin settings ( ND Learning ), insert your currency and assign the previous pages created to related select field.
5. Start create your courses, teachers and related taxonomies ( categories ).
6. Follow the detailed documentation of the plugin [HERE](http://documentation.cleanthemes.net/plugin-settings/).

== Screenshots ==

1. Archive with search filter with ajax
2. Single course page - description
3. Single course page - reviews
4. Single course page - teachers
5. Single course page - attendees
6. Single course page - documents
